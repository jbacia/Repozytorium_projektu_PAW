...
urlpatterns = [
    ...
    path("przypisz-klienta/<int:pk>/", views.przypisz_klienta, name="przypisz-klienta"),
    ...
    path("html/agents/<int:pk>/", views.agent_detail_html, name="agent-detail-html"),
    path("html/agents/<int:pk>/edytuj/", views.agent_update_html, name="agent-update-html"),
    ...
    path("html/properties/<int:pk>/", views.property_detail_html, name="property-detail-html"),
    path("html/properties/<int:pk>/edytuj/", views.property_update_html, name="property-update-html"),
    ...
    path("html/klienci/<int:pk>/", views.klient_detail_html, name="klient-detail-html"),
    path("html/klienci/<int:pk>/edytuj/", views.klient_update_html, name="klient-update-html"),
    ...
    path("html/property-types/<int:pk>/", views.propertytype_detail_html, name="propertytype-detail-html"),
    path("html/property-types/<int:pk>/edytuj/", views.propertytype_update_html, name="propertytype-update-html"),
